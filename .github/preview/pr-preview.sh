...
#
# Expects on the VPS: docker, nginx with a conf.d include, and the Cloudflare origin
# certificate at $CERT_PATH/$KEY_PATH. `deploy` also expects GHCR_USER and GHCR_TOKEN in
# the environment for the registry login.
set -eu
