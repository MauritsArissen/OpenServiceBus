...
Properties the broker enforces round-trip faithfully: `Status`, `AutoDeleteOnIdle`, `MaxSizeInMegabytes`, `MaxMessageSizeInKilobytes`, `LockDuration`, `MaxDeliveryCount`,
...
`EnableBatchedOperations`, `EnablePartitioning`,
